...
# 배경 이미지 불러오기
background = pygame.image.load("C:/Users/pjh09/OneDrive/바탕 화면/nadocoding/pygmae_basic/background.png")


# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:/Users/pjh09/OneDrive/바탕 화면/nadocoding/pygmae_basic/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:/Users/pjh09/OneDrive/바탕 화면/nadocoding/pygmae_basic/enemy.png")
...
while running:
    ...
    for event in pygame.event.get():   # 어떤 이벤트가 발생하였는가?
        ...
        if event.type == pygame.KEYDOWN:   # 키가 눌러졌는지 확인
            ...
            elif event.key == pygame.K_RIGHT:  # 캐릭터를 오른쯕으로
                to_x += character_speed
